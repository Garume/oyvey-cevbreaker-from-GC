...
import me.alpha432.oyvey.event.MultiPhase;
import me.alpha432.oyvey.event.Phase;
import me.alpha432.oyvey.event.oyveyEvent;
import me.alpha432.oyvey.util.EnumUtils;
import me.alpha432.oyvey.util.PlayerPacket;
import net.minecraft.util.math.Vec2f;
import net.minecraft.util.math.Vec3d;

public class OnUpdateWalkingPlayerEvent extends oyveyEvent implements MultiPhase<OnUpdateWalkingPlayerEvent> {
